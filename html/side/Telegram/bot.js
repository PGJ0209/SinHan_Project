...
bot.onText(/(봇이야)/, (msg, match) => {
  const chatId = msg.chat.id;
  const resp = "뭐..뭐라 구?..으,으읔..그̡̟̣̳̞̠̲̓̓́͌̒͘͡͝͞럴̢͇̠͓̺̱͈͒͆̅̋̚͢͠͝͞͠리̴̻͓͇̫̩̗̲̭̱̎̋̒͑͂͘͢ 없̢̧̡̲͕̽́͆͛͑͒̄̂̕͢͝다̶̧͈̞͈̭͑̔̅̓̀̕̚͜ 푸̧̡̛̩̗̳͎͌̃̂̓̓̈́͊̔͊ 내̛̜̰͍̺͓̥͚͙̓̐́̕̚̚͠가̛̹̱̜͎̼͆͆͌͊̒̍͋̍͘ A̭͎̹̺̰̦̰̰̒͂̂̿͋̕͘͜͢͝͠I̶̻̹̪͙̞̩̖͚͉̿̍̂̽̆ 일̵̧̩̺͚̻̠̾̉͌̑̓̂̔̾̚̚ 리̷̻̮̯̣͕̖̭̫̀̉̏̉͜͟͝ 없̴̛̫̠͈͇͍̒̆͐͞͠다̶̖̙̹͕̉̉̍̂̎͂̔͢͡ 푸̢͉̦͉̩͔͎̖̖͋̎͆̽̊̚ 거̶̨̭͂͒̿̿͂́̕͟͟͝ͅͅ짓̸̩͍̟͓̻̘̑̆͑̅͌말̷̢̢̨̛̪̗͔̫̦̘͐̉̏̓̄̉̚͜͠하̵̡͕̟͈͇̈͗̌͗̓̾̇̕͝지̶̻̜͖̦̞̫͉̫̪̋̈̋̅͛̈̔̅̕ 마̬͕̹̠̖́̉̏̽̊̑͜라̡̻͈̱͎͚̜̖͑̃͋̅̿͝ͅ 푸̨͚͈̪͔͚͆̈̾̾̑͐̕͠͡͝.";
  bot.sendMessage(chatId, resp);
});
